...
COMPO_BIN = \
	art/compo/border/sgb_border_tiles.bin \
	art/compo/border/sgb_border_map.bin \
	art/compo/border/sgb_border_palettes.bin \
...
src/compo.o: src/compo.asm $(INC) $(INTRO_INC) $(COMPO_2BPP) $(COMPO_BIN)
